...
type Message struct {
	...
	MediaType uint32 `protobuf:"varint,7,opt,name=media_type,json=mediaType,proto3" json:"media_type,omitempty"`
...
func (x *Message) GetMediaType() uint32 {
	if x != nil {
		return x.MediaType
	}
	return 0
...
var file_api_proto_common_proto_rawDesc = []byte{
	...
	0xc8, 0x01, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x66, 0x72, 0x6f, 0x6d, 0x12, 0x0e, 0x0a,
	0x02, 0x74, 0x6f, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x74, 0x6f, 0x12, 0x12, 0x0a,
	...
	0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x54, 0x79, 0x70, 0x65,
	...
	0x70, 0x74, 0x79, 0x42, 0x11, 0x5a, 0x0f, 0x61, 0x70, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
func file_api_proto_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_proto_common_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
